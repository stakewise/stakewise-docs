...
You can also start the nodes together with the Operator Service using the `--run-nodes` flag in the `start` command. You can learn more in the [Running the Operator Service →](./start-operator) section.
