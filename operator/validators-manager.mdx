...
<img src={require('./create-meta-vault/img/export-private-key-720.gif').default} alt="export-private-key" style={{maxWidth: '500px', width: '100%', borderRadius: '12px', marginBottom: '1rem'}} />
