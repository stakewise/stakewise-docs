...
Follow the command prompts. You will be asked to enter your Vault address during this step (see [Where to Find Your Vault Address →](/operator/create-regular-vault#where-to-find-your-vault-address)).
