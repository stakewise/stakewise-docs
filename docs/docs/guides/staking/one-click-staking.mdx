...
sidebar_position: 2
description: "How to stake ETH with one click on StakeWise. Get osTokens instantly with automatic diversification across top-performing Vaults."
---
...
<Image img={require('./img/staking_flow.png')} alt="StakeWise one-click staking flow diagram" />
