...
[Detailed setup instructions →](/operator/staking-nodes#execution-client).
...
[Detailed setup instructions →](/operator/staking-nodes#consensus-client)
...
The Operator Service runs seamlessly with any node setup, supporting your preferred execution and consensus clients, MEV relay, and distributed validator technology. [Complete setup guide →](/operator/launch-operator-service-v4)
