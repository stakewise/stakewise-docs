...
<div style={{textAlign: 'center', margin: '2rem 0'}}>
  <pre style={{
    ...
    <strong style={{fontSize: '16px', borderBottom: '2px solid #018970', paddingBottom: '0.5rem', display: 'inline-block', marginBottom: '1rem'}}>🏛️ Architecture Overview</strong>
     ...
     📦 Your Vault &rarr; 🎯 Operator Service &rarr; ⛓️ Beacon Chain
     
     Smart Contract     Bridge & Manager     Validator Registration
  </pre>
</div>
...
By default, the fees earned by the Vault fee recipient remain locked in the validators.
You can enable periodic fee claims through the Operator Service.
