...
:::custom-notes[Prerequisites]
Before using automated node setup, you must have a **deployed StakeWise Vault**. See the [Deployed Vault →](Prerequisites#deployed-vault) section in Prerequisites.
:::
