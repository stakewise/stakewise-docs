...
description: Explore additional StakeWise Operator actions including extra rewards, fee claiming, monitoring, validator consolidation, manual exits, and more.
sidebar_position: 9
---
...
[Process Meta Vaults →](./process-metavaults) — update states and process deposits and exits for meta vaults.
