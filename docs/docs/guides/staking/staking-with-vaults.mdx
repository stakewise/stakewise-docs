...
Your osToken position has health levels (Healthy, Moderate, Risky, Unhealthy) based on your Vault's performance relative to osTokens. Monitor this regularly to avoid liquidation. [Learn more →](/docs/ostoken/how-ostoken-works#position-health)
:::
