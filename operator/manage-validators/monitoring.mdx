---
title: Monitoring
description: Monitor your StakeWise Operator Service with Prometheus and Grafana. Set up metrics endpoints and configure scraping for validator operations.
sidebar_position: 1
---
