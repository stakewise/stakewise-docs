...
<Image img={require('./img/validator_registration.png')} alt="validator_registration" />
...
<Image img={require('./img/rewards_distribution.png')} alt="rewards_distribution" />
...
<Image img={require('./img/withdrawal_process.png')} alt="withdrawal_process" />
...
<Image img={require('./img/exit_process.png')} alt="exit_process" />
