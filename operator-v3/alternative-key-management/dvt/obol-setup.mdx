---
title: Obol Setup
description: Set up a distributed validator cluster with Obol Network and StakeWise Operator v3 using Charon middleware and Docker Compose.
sidebar_position: 3
---
...
<p style={{fontSize: '1.2em', color: 'rgba(var(--moon-rgb), .5)', marginTop: '-10px', marginBottom: '20px'}}>Setting Up a Distributed Validator Cluster with Obol Network and StakeWise Vaults</p>
...
4. [Setup Operator Service →](/operator/v3/installation)
...
## <img src="/icons/stakewise/cursor.png" alt="cursor" style={{width: '36px', height: '36px', display: 'inline', verticalAlign: 'middle'}} /> Additional Resources
