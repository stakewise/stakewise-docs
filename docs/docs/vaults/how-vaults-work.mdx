...
![validator_registration](./img/validator_registration.png)
...
![rewards_distribution](./img/rewards_distribution.png)
...
![withdrawal_process](./img/withdrawal_process.png)
...
![exit_process](./img/exit_process.png)
