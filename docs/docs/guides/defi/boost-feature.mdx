...
<div style={{textAlign: 'center', margin: '2rem 0'}}>
  <pre style={{
    ...
    <strong style={{fontSize: '16px', borderBottom: '2px solid var(--lavender)', paddingBottom: '0.5rem', display: 'inline-block', marginBottom: '1rem'}}>🚀 Boost Flow</strong>
...
To use Boost, you need osTokens in your wallet. If you don't have any, see the [staking guide →](/docs/guides/staking/intro) for instructions on minting osTokens from your stake.
:::
