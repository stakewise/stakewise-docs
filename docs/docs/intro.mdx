...
This documentation helps you use StakeWise for staking and offering staking. It explains the modular architecture of Vaults - the smart contracts that enable non-custodial, customizable, and permissionless staking - and the tokenomics behind OsToken's instant liquidity. It provides both theoretical understanding of protocol mechanics and practical acumen to unlock your capital's full potential. Whether you're new to liquid staking, running your own infrastructure, or deep into DeFi, it gives you everything needed for a confident start.

<h2>Understanding Liquid Staking</h2>

<h3>The Traditional Staking Dilemma</h3>
<h4>What is Staking?</h4>
Staking is a cryptoeconomic mechanism that uses rewards and penalties to incentivize proper network behavior, thereby enhancing underlying security. In proof-of-stake blockchains like Ethereum, participants run <Tooltip content={<><strong>Validator</strong> <br /> A <a href="./glossary#node" style={{textDecoration: 'underline', color: '#018970'}}>node</a> in a proof-of-stake system responsible for storing data, processing transactions, and adding new blocks to the blockchain. To activate validator software, you need to be able to stake 32 ETH.</>}>validator</Tooltip>nodes by putting tokens "at stake" - earning rewards for validating transactions but risking "slashing" (penalties) for malicious or unreliable behavior. Validators play an essential role in maintaining network consensus, enabling all participants to agree on the blockchain's new irreversible global state. For this critical work, validators receive two types of rewards:
...
- DeFi yields in a multitude of opportunities: collateral for lending, yield farming strategies, or trading on decentralized exchanges (DEXs)
