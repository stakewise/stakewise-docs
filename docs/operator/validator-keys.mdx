...
Keystores saved to ~/.stakewise/mainnet/keystores file
```
</details>

:::custom-notes[Keystore Locations]
  - Keystores are saved to `~/.stakewise/mainnet/keystores`
...
1. Locate your keystores in `~/.stakewise/mainnet/keystores`
