...
Now that you know what operating a Vault involves, let's look at the software that makes it all work.
...
1. **[Create your Vault →](./create-your-vault)** — done via the StakeWise UI in minutes. You'll need the Vault address for the next step.

2. **[Launch the Operator Service →](./launch-operator-service/overview)** — install, configure, and start the service for your Vault.
