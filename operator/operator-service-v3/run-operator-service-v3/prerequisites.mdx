...
You will need your Vault contract address for Operator Service configuration. If you haven't [created a Vault](/operator/create-your-vault) yet, do that first — otherwise, see [where to find your Vault address](/operator/create-your-vault#where-to-find-your-vault-address).
