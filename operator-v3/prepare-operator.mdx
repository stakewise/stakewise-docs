...
Alternatively, you may use external tools such as [Wagyu Keygen ↗](https://github.com/stake-house/wagyu-key-gen) to generate keystores, and existing wallets like [MetaMask ↗](https://metamask.io/) or [MyEtherWallet ↗](https://help.myetherwallet.com/en/articles/6512619-using-mew-offline) for the Operator wallet.
...
<div style={{textAlign: 'center', margin: '2rem 0'}}>
  <pre style={{
    ...
    <strong style={{fontSize: '16px', borderBottom: '2px solid var(--lavender)', paddingBottom: '0.5rem', display: 'inline-block', marginBottom: '1rem'}}>🤖 Prepare Operator</strong>

     📝 Initialize Mnemonic
       ↓
     🔐 Generate Validator Keys &rarr; 📁 Keystores + 📄 Deposit Data File
       ↓
...
🎉 Your Operator Service is now set up! Continue to [Start Operator →](start-operator) to launch your Operator Service.
