...
There is no default assignment - this role is initially set to the zero address and must be explicitly assigned by the Admin.
...
By default, Admin is also the Whitelist/Blocklist manager.
However, they can assign this role to another wallet, and reclaim this role at any moment in the future.

#### Validators manager

Can manage Vault validators. Set this to the wallet address attached to the Operator Service.

By default, Admin is also the Validators manager.
However, they can assign the Validators manager role to another wallet, and reclaim this role at any moment in the future.
...
<div id="fn-2" style={{fontSize: '0.85em', color: '#6b7280', marginTop: '2rem', listStyle: 'none', fontFamily: 'Fragment Mono, ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace'}}>
  <span>2.</span>
  ...
  <a href="#fnref-2" style={{color: '#6b7280', textDecoration: 'none'}}>↩</a>
</div>

<div id="fn-3" style={{fontSize: '0.85em', color: '#6b7280', marginTop: '2rem', listStyle: 'none', fontFamily: 'Fragment Mono, ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace'}}>
  <span>3.</span>
  ...
  <a href="#fnref-3" style={{color: '#6b7280', textDecoration: 'none'}}>↩</a>
</div>

<div id="fn-4" style={{fontSize: '0.85em', color: '#6b7280', marginTop: '2rem', listStyle: 'none', fontFamily: 'Fragment Mono, ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace'}}>
  <span>4.</span> [EIP-4788](https://eips.ethereum.org/EIPS/eip-4788) is currently in the project phase and proposes a method to expose Ethereum's beacon chain block roots inside the EVM by committing each beacon block's hash tree root into execution payload headers and storing them in a smart contract. <a href="#fnref-4" style={{color: '#6b7280', textDecoration: 'none'}}>↩</a>
</div>

<div id="fn-5" style={{fontSize: '0.85em', color: '#6b7280', marginTop: '2rem', listStyle: 'none', fontFamily: 'Fragment Mono, ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace'}}>
  <span>5.</span> To disable this, use the flag `--disable-withdrawals` — in this case, funds will be withdrawn via full exits using oracles. <a href="#fnref-5" style={{color: '#6b7280', textDecoration: 'none'}}>↩</a>
</div>

<div id="fn-6" style={{fontSize: '0.85em', color: '#6b7280', marginTop: '2rem', listStyle: 'none', fontFamily: 'Fragment Mono, ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, Courier New, monospace'}}>
  <span>6.</span> To qualify for the higher LTV, Vaults must meet strict DAO-defined criteria, including: Minimum stake: ≥ 10k ETH (for osETH) or ≥ 5k GNO (for osGNO); Vault fee ≤ 5% for ETH, ≤ 15% for GNO; Consistently above-median performance; Running the latest Vault version; Locked SWISE bond: 5M for ETH, 1M for GNO. <a href="#fnref-6" style={{color: '#6b7280', textDecoration: 'none'}}>↩</a>
</div>
