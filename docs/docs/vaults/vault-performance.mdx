...
**<img src="/icons/stakewise/rewards.png" alt="rewards" style={{width: '24px', height: '24px', display: 'inline', verticalAlign: 'middle', marginLeft: '15px'}} />Proposer Performance** (**20% weight**)

**<img src="/icons/stakewise/sparks.png" alt="sparks" style={{width: '24px', height: '24px', display: 'inline', verticalAlign: 'middle', marginLeft: '15px'}} />Attester Performance** (**80% weight**)
