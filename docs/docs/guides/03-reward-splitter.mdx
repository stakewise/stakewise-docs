...
Reward Splitter automatically distributes Vault staking fees among multiple shareholders according to predefined percentages at regular intervals.

## How to Set Up Reward Splitters
...
You can modify your Reward Splitter anytime:
...
- [Vault fee management →](/docs/protocol-concepts/Fees#vault-fees)
- [Vault creation guide →](/docs/guides/running-a-vault)
- [Fee claiming →](/docs/guides/running-a-vault)
:::
