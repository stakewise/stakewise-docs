...
description: Review the prerequisites for running StakeWise Operator v3, including execution and consensus client requirements and Vault deployment steps.
sidebar_position: 2
---
