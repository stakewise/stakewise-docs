...
- **[StakeWise Operator →](/operator/launch-operator-service-v4)** — Registers validators in the Vault contract. The Operator does not have access to validator keystores.
