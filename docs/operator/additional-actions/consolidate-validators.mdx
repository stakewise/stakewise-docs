...
:::custom-warning[Important Notes]
You can pass `--max-consolidation-request-fee-gwei` to set a custom maximum fee (in Gwei)
for submitting a consolidation request per validator. The default is 1000 Gwei.
:::
