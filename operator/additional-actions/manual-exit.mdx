---
title: Manual Exit
description: Manually exit StakeWise Vault validators for emergency, maintenance, or testing scenarios. Configure exit-validators command options and indexes.
sidebar_position: 5
---
