...
Learn more about tracking performance metrics in [Monitoring →](../../operator/operator-monitoring) and [Rated Network integration →](../../operator/manage-validators/rated-network).
:::
