...
The [Operator Service →](../../operator/launch-operator-service-v4/overview) periodically checks whether its Vaults have accumulated enough ETH for registering new validator(s).
