...
1. [Installation →](/operator/launch-operator-service-v4/installation) completed
2. [Validators Manager →](/operator/launch-operator-service-v4/validators-manager), which is set to the wallet address of the Relayer.
...
For Docker-specific setup instructions, see [Installation →](../launch-operator-service-v4/installation#configuration)
:::
