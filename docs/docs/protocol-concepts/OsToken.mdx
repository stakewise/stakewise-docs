...
Find step-by-step instructions for each staking option in the [Staking Guide →](/docs/guides/staking).
:::
...
For comprehensive information about all protocol fees, see the [Fees →](./Fees) chapter.
:::
