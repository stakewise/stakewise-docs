...
- **<img src="/img/stakewise/cursor.png" alt="cursor" style={{width: '24px', height: '24px', display: 'inline', verticalAlign: 'middle'}} />Track Performance**: Monitor your Vault's APY and your earned rewards
- **<img src="/img/stakewise/osETH.png" alt="osETH" style={{width: '24px', height: '24px', display: 'inline', verticalAlign: 'middle'}} />Mint/Burn osTokens**: Adjust your liquid staking position as needed ([Learn about minting →](/docs/ostoken/how-ostoken-works#minting) | [Learn about burning →](/docs/ostoken/how-ostoken-works#burning))
- **<img src="/img/stakewise/rocket.png" alt="rocket" style={{width: '24px', height: '24px', display: 'inline', verticalAlign: 'middle'}} />Use Boost**: Increase your staking rewards with additional yield opportunities
- **<img src="/img/stakewise/key.png" alt="key" style={{width: '24px', height: '24px', display: 'inline', verticalAlign: 'middle'}} />Unstake**: Exit the Vault (requires burning all minted osTokens first)
- **<img src="/img/stakewise/vault.png" alt="vault1" style={{width: '24px', height: '24px', display: 'inline', verticalAlign: 'middle'}} />Switch Vaults**: Unstake from one and stake in another for better terms
