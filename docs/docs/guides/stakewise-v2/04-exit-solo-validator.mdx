...
Note that you must [**rotate your Solo validator withdrawal credentials**](./03-change-solo-withdrawal-credentials-to-0x01-address) to 0x01 withdrawal address before you can request a validator exit. This is a technical requirement of the Ethereum network.&#x20;
:::
