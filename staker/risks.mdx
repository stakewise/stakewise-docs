...
## <img src="/icons/stakewise/rewards.png" alt="Vault Performance" style={{width: '32px', height: '32px', display: 'inline', verticalAlign: 'middle'}} /> Vault Performance
...
## <img src="/icons/code.svg" alt="Smart Contract" style={{width: '32px', height: '32px', display: 'inline', verticalAlign: 'middle'}} /> Smart Contract
...
## <img src="/icons/glossary/oseth.png" alt="osETH Depeg" style={{width: '32px', height: '32px', display: 'inline', verticalAlign: 'middle'}} /> osETH Depeg
...
## <img src="/icons/glossary/boost.png" alt="Boost" style={{width: '32px', height: '32px', display: 'inline', verticalAlign: 'middle'}} /> Boost
