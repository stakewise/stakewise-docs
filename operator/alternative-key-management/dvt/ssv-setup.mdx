---
title: SSV Setup
description: Run StakeWise validators using SSV Network DVT. Generate operator keys, run an SSV node, register as an operator, and distribute validator key shares.
---
