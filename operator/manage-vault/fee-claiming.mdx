---
title: Fee Claiming
description: Automate periodic fee claiming for StakeWise Vault shareholders using the Fee Splitter system. Configure intervals, thresholds, and gas optimization.
sidebar_position: 3
---
...
Automated fee claiming is only available for Operator Service V4. [Upgrade →](/operator/operator-service-v3/v4-upgrade-guide)
:::
