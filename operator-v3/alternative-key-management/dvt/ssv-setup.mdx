...
1. <img src="/img/stakewise/key.png" alt="key" style={{width: '24px', height: '24px', display: 'inline', verticalAlign: 'middle'}} />Generate encrypted operator keys
2. <img src="/img/stakewise/laptop.png" alt="laptop" style={{width: '24px', height: '24px', display: 'inline', verticalAlign: 'middle'}} />Run your own SSV node
3. <img src="/img/stakewise/tick.png" alt="tick" style={{width: '24px', height: '24px', display: 'inline', verticalAlign: 'middle'}} />Register as an SSV operator
4. <img src="/img/stakewise/defi.png" alt="defi" style={{width: '24px', height: '24px', display: 'inline', verticalAlign: 'middle'}} />Distribute your validator keys to cluster operators
