...
<Tabs groupId="installation-methods">
  ...
  <TabItem value="kubernetes" label="Kubernetes (Advanced)">
    ...
    A dedicated guide is available for running Operator Service on Kubernetes, designed for large-scale validator deployments (up to 10,000).
...
Once installed, continue with [Key Creation ↗](key-creation).
