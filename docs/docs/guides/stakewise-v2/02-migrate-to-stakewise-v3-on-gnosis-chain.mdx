...
This step marks the successful completion of the migration. Congratulations! <img src="/img/stakewise/cup.png" alt="cup" style={{width: '24px', height: '24px', verticalAlign: 'middle', display: 'inline'}} />
