...
<div style={{textAlign: 'center', margin: '2rem 0'}}>
  <pre style={{
    ...
    <strong style={{fontSize: '16px', borderBottom: '2px solid var(--lavender)', paddingBottom: '0.5rem', display: 'inline-block', marginBottom: '1rem'}}><img src="/icon/flow.png" alt="Flow" style={{width: '16px', height: '16px', display: 'inline', marginRight: '4px', verticalAlign: 'text-bottom'}} /> Staking Flow</strong>
    <img src="/icon/tokens/ethereum.svg" alt="ETH" style={{width: '16px', height: '16px', display: 'inline', marginRight: '4px', verticalAlign: 'text-bottom'}} /> Your Assets &rarr; <img src="/icon/safe.png" alt="Vault" style={{width: '16px', height: '16px', display: 'inline', marginRight: '4px', verticalAlign: 'text-bottom'}} /> StakeWise Vaults &rarr; <img src="/icon/tokens/osETH.svg" alt="osETH" style={{width: '16px', height: '16px', display: 'inline', marginRight: '4px', verticalAlign: 'text-bottom'}} /> osTokens &rarr; 💰 Earn Rewards
  </pre>
</div>
