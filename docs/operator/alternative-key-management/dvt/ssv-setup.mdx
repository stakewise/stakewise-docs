...
<p style={{fontSize: '1.2em', color: '#6c757d', marginTop: '-10px', marginBottom: '20px'}}>A complete guide to running StakeWise validators using SSV Network's distributed validator technology.</p>
...
2. 🖥️ Run your own SSV node
3. ✍️ Register as an SSV operator
...
SSV node requires (in addition to your beacon/execution nodes): ⚙️ 2 cores, ⚡️ 2GB RAM, 💾 20GB storage, 🚀 >8K IOPS. See [full requirements ↗](https://docs.ssv.network/operators/operator-node/node-setup/hardware-requirements).
:::
...
```json {22}
{
  "checksum": {
    "function": "sha256",
    "message": "4abcbd7fffd92cd911f490d21fc6a8cd4a1f8fcfeab2e1da38d51d99103e4252",
    "params": {}
  },
  "cipher": {
    "function": "aes-128-ctr",
    "message": "ee58cc1bc1ab53a3333f97d4bc3c8eb...",
    "params": { "iv": "e4f98b6bbde33006f1178b4bbe0b32c1" }
  },
  "kdf": {
    "function": "pbkdf2",
    "message": "",
    "params": {
      ...
      "dklen": 32,
      "prf": "hmac-sha256",
      "salt": "17d70de541658cd9e5f02105ea1887e7a2a8f0e3dd8b9769f12b821b1e0bc96f"
    }
  },
