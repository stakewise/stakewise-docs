...
Registers validators in the vault contract. Operator does not have access to validator keystores.

### DVT Relayer

Collects deposit and exit signatures from validators (via Sidecars) and forwards them to oracles.
