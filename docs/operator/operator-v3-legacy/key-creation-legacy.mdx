...
<div style={{textAlign: 'center', margin: '2rem 0'}}>
  <pre style={{
    ...
    <strong style={{fontSize: '16px', borderBottom: '2px solid #018970', paddingBottom: '0.5rem', display: 'inline-block', marginBottom: '1rem'}}>🔑 Key Generation Flow</strong>

     📝 Mnemonic
       ├─ 🔐 Validator Keys &rarr; 📁 Keystores + 📄 Deposit Data &rarr; ✅ Import to Client
       └─ 💳 Wallet &rarr; 💰 Fund with ETH &rarr; 📤 Upload Deposit Data &rarr; 🚀 Register Validators
  </pre>
</div>
...
<Tabs groupId="upload-methods">
  ...
  <TabItem value="operator" label="Operator Service">
    ...
    - [Ethereum Mainnet ↗](https://etherscan.io/address/0x75AB6DdCe07556639333d3Df1eaa684F5735223e)
    - [Gnosis Chain ↗](https://gnosisscan.io/address/0x58e16621B5c0786D6667D2d54E28A20940269E16)
  </TabItem>
</Tabs>
...
With your keys, deposit data, and wallet prepared, continue to [Getting Started ↗](getting-started) to configure your Vault permissions and launch the Operator Service.
