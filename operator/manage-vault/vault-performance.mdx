...
Learn more about tracking performance metrics in [Monitoring →](/operator/manage-validators/monitoring) and [Rated Network integration →](/operator/manage-validators/rated-network).
:::
