...
Beyond validator registration, the StakeWise Operator supports several additional actions to simplify and improve Vault management.
...
### Exit Validators
Trigger validator exits when needed.
