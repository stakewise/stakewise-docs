...
**<img src="/img/stakewise/rocket.png" alt="rocket" style={{width: '24px', height: '24px', verticalAlign: 'middle', display: 'inline'}} /> Setup difficulty:** Moderate – requires running Ethereum nodes and basic command-line familiarity.

## Setup Checklist <span style={{display: 'inline'}}><img src="/img/stakewise/tick.png" alt="tick" style={{width: '36px', height: '36px', verticalAlign: 'middle', display: 'inline'}} /></span>
