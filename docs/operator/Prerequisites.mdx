...
<Admonition type="warning" icon={<img src={useBaseUrl('/img/exclamation_mark.png')} alt="Warning" style={{ width: 20, height: 20 }}/>} title="Mandatory Vault Version Upgrade">
  Before running the Operator Service, you must upgrade your Vault to the required version:
  <ul style={{ listStyleType: "disc", paddingLeft: "20px" }}>
    <li>**Ethereum**: Upgrade to Vault version 5</li>
    <li>**Gnosis**: Upgrade to Vault version 3</li>
  </ul>
  Visit your Vault page on the StakeWise interface to check your current version and perform the upgrade if necessary.
</Admonition>
