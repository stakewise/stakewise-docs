...
<p style={{fontSize: '1.2em', color: 'rgba(var(--moon-rgb), .5)', marginTop: '-10px', marginBottom: '20px'}}>A complete guide to running validators using SSV Network's distributed validator technology.</p>
...
1. <img src="/icons/stakewise/key.png" alt="key" style={{width: '24px', height: '24px', display: 'inline', verticalAlign: 'middle'}} />Generate encrypted operator keys
2. <img src="/icons/stakewise/laptop.png" alt="laptop" style={{width: '24px', height: '24px', display: 'inline', verticalAlign: 'middle'}} />Run your own SSV node
3. <img src="/icons/stakewise/tick.png" alt="tick" style={{width: '24px', height: '24px', display: 'inline', verticalAlign: 'middle'}} />Register as an SSV operator
4. <img src="/icons/stakewise/defi.png" alt="defi" style={{width: '24px', height: '24px', display: 'inline', verticalAlign: 'middle'}} />Distribute your validator keys to cluster operators
...
```
3. [Create Vault →](/operator/create-your-vault)
4. [Setup Operator Service →](/operator/operator-service-v3/run-operator-service-v3/installation)
...
While there are different [setup options ↗](https://docs.ssv.network/operators/operator-node/node-setup/#other-setup-options) with the [SSV Stack ↗](https://docs.ssv.network/operators/operator-node/node-setup/) being the most straightforward option, this guide covers **Manual Setup** offering full customization and control. Let's get started <img src="/icons/stakewise/rocket.png" alt="rocket" style={{width: '24px', height: '24px', display: 'inline', verticalAlign: 'middle'}} />.
