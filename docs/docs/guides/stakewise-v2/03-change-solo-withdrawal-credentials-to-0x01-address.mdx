...
````mdx-code-block
  <Tabs
    ...
    <TabItem value="windows">
        ...
        To obtain your validator indices and withdrawal credentials, please contact the StakeWise team via [Discord ↗](https://discord.gg/stakewise) or email at [info@stakewise.io <img src="/img/Email.png" alt="Email" style={{width: '18px', height: '18px', display: 'inline', verticalAlign: 'middle'}} />
](mailto:info@stakewise.io)
        :::
