...
1. Open [app.stakewise.io](https://app.stakewise.io) and connect your wallet.
2. Click the **flip** button <img src="/icons/flip_button.png" alt="flip button icon" style={{height: '2.5em', verticalAlign: 'middle', display: 'inline-block'}} /> to switch from staking to unstaking mode.
