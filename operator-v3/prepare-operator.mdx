...
2. `deposit_data.json` - Contains validator registration information including public keys, withdrawal credentials, and cryptographic signatures. This file must be uploaded to your Vault (Step 5) to authorize the Operator Service to register your validators.
...
You can always add more validator keys to your Vault by repeating this step.
