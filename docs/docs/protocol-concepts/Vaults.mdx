...
Each vault is highly customizable. Core parameters set at deployment – like vault type, capacity, MEV strategy, ERC-20 support, and management roles are immutable, while branding and fees remain adjustable.
