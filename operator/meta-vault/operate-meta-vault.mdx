...
The [Operator Service ↗](https://github.com/stakewise/v3-operator) performs these actions on behalf of the Meta Vault. Once configured, it runs continuously. On every new block, it traverses the Meta Vault tree and submits one multicall transaction per Meta Vault to:
