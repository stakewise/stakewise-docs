...
- **<img src="/icons/stakewise/rewards.png" alt="rewards" style={{width: '24px', height: '24px', display: 'inline', verticalAlign: 'middle'}} />Proposer Performance** (**20% weight**)
- **<img src="/icons/stakewise/sparks.png" alt="sparks" style={{width: '24px', height: '24px', display: 'inline', verticalAlign: 'middle'}} />Attester Performance** (**80% weight**)
:::
...
Learn more about tracking performance metrics in [Monitoring →](../../operator/additional-actions/monitoring) and [Rated Network integration →](../../operator/additional-actions/rated-network).
:::
