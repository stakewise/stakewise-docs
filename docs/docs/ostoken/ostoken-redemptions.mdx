...
The redemption flow is coordinated between the [Operator Service ↗](https://github.com/stakewise/v3-operator), which computes who can be redeemed and by how much, and the [OsTokenRedeemer ↗](https://etherscan.io/address/0xc43A7b16A7a167c0318390Cba16787C11e9e1FD0) contract, which executes redemptions.
...
<div style={{backgroundColor: '#FFF4E6', color: '#3a2a00', padding: '0.6rem 0.8rem', borderRadius: '6px'}}><strong>Note:</strong> This is the <code>OsTokenRedeemer</code>'s own exit queue, independent of the Vault exit queue.</div>
