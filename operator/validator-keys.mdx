...
<div style={{textAlign: 'center', margin: '2rem 0'}}>
  <pre style={{
    ...
    <strong style={{fontSize: '16px', borderBottom: '2px solid var(--lavender)', paddingBottom: '0.5rem', display: 'inline-block', marginBottom: '1rem'}}>🔑 Validator Keys Setup</strong>
