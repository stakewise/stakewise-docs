...
Verify that your validator clients are configured with the correct **fee recipient address**. You can locate this address on the Vault page in the **Details** section.
:::
...
Learn more about tracking performance metrics in [monitoring →](./monitoring) and [Rated Network integration →](./rated-network).
:::
