...
:::custom-notes[Don't See the Migrate Option?]
The Migrate entry point only appears when the connected wallet holds a non-zero StakeWise V2 balance. If it isn't there, check that you are connected with the wallet that holds the V2 tokens and are on the right network.
:::
