...
Incentives will be allocated every hour to all Vault users based on their staked balance, with `merkle root` updates by Oracles DAO. Users can claim their incentives at any time through the [StakeWise App ↗](https://app.stakewise.io/):
