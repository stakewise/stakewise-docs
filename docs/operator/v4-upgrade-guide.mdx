...
Additionally, ensure your Operator Service wallet has the [Validators Manager →](validators-manager#step-2-assign-validators-manager-role) role assigned in your Vault settings for proper operation.
:::
...
To migrate `0x01` validators to `0x02`, use the `consolidate` command. Read more about it [here →](./additional-actions/consolidate-validators).
:::
...
🔗 **Setup Guide**: [How to Set Up Validators Manager →](./validators-manager).
:::
...
For detailed instructions on fee claiming, see [Fee Claiming →](./additional-actions/fee-claiming).
:::
