...
Starting with v4.1.0, the Operator Service includes built-in commands to automatically install and manage execution and consensus clients (Reth and Lighthouse), simplifying the entire staking setup process. See [Automated Node Setup →](node-setup) for details.
:::
