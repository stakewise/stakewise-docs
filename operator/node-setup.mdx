...
Starting with v4.1.0, the Operator Service can automatically install and manage [Reth ↗](https://github.com/paradigmxyz/reth) (execution) and [Lighthouse ↗](https://github.com/sigp/lighthouse) (consensus) clients.
