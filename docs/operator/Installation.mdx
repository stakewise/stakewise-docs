...
<Tabs groupId="installation-methods">
  ...
  <TabItem value="docker" label="Docker Image">
    ...
    ```bash
    docker pull europe-west4-docker.pkg.dev/stakewiselabs/public/v3-operator:v4.0.4
    ```
    ...
    cd v3-operator
    docker build --pull -t europe-west4-docker.pkg.dev/stakewiselabs/public/v3-operator:v4.0.4 .
    ```
