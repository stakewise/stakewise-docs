...
You can either specify `--source-public-keys` (`0x01` or `0x02` validators) and `--target-public-key` (`0x02` validators) parameters to consolidate specific validators, or run without these parameters for automatic consolidation:
