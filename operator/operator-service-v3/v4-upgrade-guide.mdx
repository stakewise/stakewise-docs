...
description: Upgrade from StakeWise Operator v3 to v4 with Pectra support, partial withdrawals, simplified commands, and automatic deposit data.
sidebar_position: 10
---
...
Additionally, ensure your Operator Service wallet has the [Validators Manager →](/operator/launch-operator-service-v4/validators-manager#step-2-assign-validators-manager-role) role assigned in your Vault settings for proper operation.
:::
...
To migrate `0x01` validators to `0x02`, use the `consolidate` command. Read more about it [here →](/operator/manage-validators/consolidate-validators).
:::
...
🔗 **Setup Guide**: [How to Set Up Validators Manager →](/operator/launch-operator-service-v4/validators-manager).
:::
...
For detailed instructions on fee claiming, see [Fee Claiming →](/operator/manage-vault/fee-claiming).
:::
