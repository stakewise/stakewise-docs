...
The osToken **exchange rate** is the amount of the underlying asset a user receives from StakeWise when redeeming osToken. It rises as staking rewards accrue, making each osToken worth more of the underlying asset over time.
