...
4. Lock each Vault's share until the Vault has been active and non-rejected through the full period (or until all its validators have fully withdrawn) — then unlock it.
:::
