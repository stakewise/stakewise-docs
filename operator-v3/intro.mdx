...
You can [check your Vault contract version →](./Prerequisites#finding-your-vault-address) in the Details section of the Vault page or on the contract page in the block explorer.If your Vault version is higher, please refer to the [latest documentation →](/operator/intro).
:::
