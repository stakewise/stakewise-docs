...
These settings **cannot be changed later**. Choose carefully before proceeding.
:::

- **📐 Vault Capacity**: Set maximum ETH capacity (default: unlimited ∞). [Learn more →](/docs/protocol-concepts/Vaults#capacity)
- **💰 Vault Fees**: Set fee percentage charged on staking rewards (e.g., 5%). [Learn more →](/docs/protocol-concepts/Fees#vault-fees)
...
Unlike Vault parameters, you can update your branding anytime: **Settings → Branding → Edit → Save**.
:::
...
At the bottom, you'll see the **"Details"** page containing all the important information for your Vault.
...
<Tabs groupId="vault-settings">
  ...
  <TabItem value="fees" label="💰 Fees">
    **Manage fees:**
    - Set rates: 0-20% of staking rewards
    - Update frequency: Once every 3 days
