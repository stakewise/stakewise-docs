...
Only registered Vaults with active validator(s) and synced rewards can mint osToken.
The ability to mint also serves as a price stability mechanism, helping prevent secondary market premiums on osToken.
You can get osToken through [simple staking](/staker/simple-staking), [vault staking](/staker/vault-staking), or by buying it on a DEX.
How much osToken you can mint against your stake depends on the LTV ratio.
...
<p style={{fontSize: '0.85em', color: 'var(--ifm-color-content-secondary)', textAlign: 'center', marginTop: '-0.5rem'}}>
