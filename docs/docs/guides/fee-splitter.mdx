---
title: Fee Splitter
description: "Configure fee distribution among multiple shareholders for your Vault's staking rewards."
sidebar_position: 3
---
...
- [Vault creation guide →](/docs/guides/running-a-vault/how-to-create-a-vault)
- [Fee claiming →](/operator/manage-vault/fee-claiming)
:::
