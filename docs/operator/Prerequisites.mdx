...
You can check your current Vault version and perform the upgrade directly from the **Details** section at the bottom of your Vault page in the StakeWise interface.
:::
...
🎉 Congratulations! Your infrastructure is now ready for [Operator Service installation ↗](installation).
