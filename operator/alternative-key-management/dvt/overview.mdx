...
4. The Relayer processes deposit and exit signature shares:
...
5. The Operator Service repeats the registration request each block, polling until all pending validators have their signatures ready.
6. Once the signatures are ready, the Operator Service registers those validators in the **Vault contract**.
