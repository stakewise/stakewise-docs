...
2. [Validators Manager →](/operator/validators-manager), which is set to the wallet address of the Relayer.
...
For Docker-specific setup instructions, see [Installation →](../installation#configuration)
:::
