...
1. **Create reward splitter** — deploys the [`RewardSplitter` ↗](https://etherscan.io/address/0xd12Df8543e0522CCbF12d231e822B7264c634775) contract for your Vault (the address shown is the factory that deploys one splitter per Vault).
