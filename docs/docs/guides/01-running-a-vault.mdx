...
**5. Running Validators** – Your validators will be automatically registered and managed by the Operator Service once it is properly configured with your [validator keys →](/operator/validator-keys) and [Validators Manager →](/operator/validators-manager) wallet.
