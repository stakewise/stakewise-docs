...
<Tooltip content={<><strong>Validator</strong> <br /> A node in a proof-of-stake system responsible for storing data, processing transactions, and adding new blocks to the blockchain.
