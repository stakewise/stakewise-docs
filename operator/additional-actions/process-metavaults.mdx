...
- **Wallet ready**: [Initialize mnemonic →](../validator-keys#step-1-initialize-mnemonic), then [create operator wallet →](../validators-manager#step-1-create-operator-wallet), or use an existing one
:::
