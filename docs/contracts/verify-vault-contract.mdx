...
sidebar_position: 2
description: Step-by-step guide to verify StakeWise vault proxy contracts on Etherscan using the ERC-1967 proxy storage standard.
---
...
1. **Find Your Vault Contract Address**
   ...
   If you need help finding your Vault contract address, see [Finding Your Vault Address →](/operator/launch-operator-service-v4/prerequisites#finding-your-vault-address) in the Prerequisites section.
