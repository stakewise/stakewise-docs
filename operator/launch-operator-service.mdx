...
- **Validator Funding** — Tops up existing `0x02` compound validators<sup><a href="#fn-1" id="fnref-1">1</a></sup> before registering new ones, up to [`--max-validator-balance-gwei`](./start-operator#optional-flags) (300 ETH on Ethereum, 1800 GNO on Gnosis by default).
...
On macOS, when you install the Operator Service, you may see a warning prompting you to move the software to the Bin.
...
<Tabs groupId="installation-methods">
  <TabItem value="binary" label="Binary" default>
    ...
    **Option A — Install script**
    ...
    <CommandSnippet template={`curl -sSfL https://raw.githubusercontent.com/stakewise/v3-operator/master/scripts/install.sh | sh -s -- -b {{<path>}} {{<version>}}`} />
  ...
  <TabItem value="source" label="Source Files">
    ...
    - [Python 3.12 ↗](https://www.python.org/downloads/) (3.13 is not supported)
