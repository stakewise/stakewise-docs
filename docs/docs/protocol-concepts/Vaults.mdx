...
These fees are set and managed by the Vault Admin.

><span style={{color: '#1f2937', fontWeight: '500'}}> 📝 For complete details about Vault fee structures, limits, update restrictions, and how they interact with protocol fees, see the dedicated [Fees →](./Fees) chapter.</span>
