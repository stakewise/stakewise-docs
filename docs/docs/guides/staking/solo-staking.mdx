...
title: Solo Staking
sidebar_position: 4
description: "Run your own Ethereum validators with StakeWise solo staking. Get maximum yields and full control while maintaining liquidity via osTokens."
---
...
1. **Create your own Vault** using our [Vault creation guide →](/operator/create-regular-vault)
2. **Set up validator infrastructure** following our [operator documentation →](/operator/launch-operator-service)
