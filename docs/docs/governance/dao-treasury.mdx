...
title: DAO Treasury
sidebar_position: 2
description: "Learn about the StakeWise DAO Treasury — a Gnosis Safe multi-sig wallet managed by a committee for executing governance decisions."
---

# DAO Treasury

<p style={{fontSize: '1.2em', color: 'rgba(var(--moon-rgb), .5)', marginTop: '-10px', marginBottom: '20px'}}>Learn more about the Treasury</p>
