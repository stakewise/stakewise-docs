...
:::custom-warning[Operator v3 Documentation (Legacy)]
This documentation is for Operator v3, which does not support Pectra upgrade features and `0x02` validators.
To use Pectra-related features, please refer to [Operator v4 Documentation →](/operator/intro)
:::
