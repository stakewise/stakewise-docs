...
- **<img src="/img/stakewise/rewards.png" alt="rewards" style={{width: '24px', height: '24px', display: 'inline', verticalAlign: 'middle'}} />Proposer Performance** (**20% weight**)
- **<img src="/img/stakewise/sparks.png" alt="sparks" style={{width: '24px', height: '24px', display: 'inline', verticalAlign: 'middle'}} />Attester Performance** (**80% weight**)
:::
