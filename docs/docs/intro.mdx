...
Since Beacon Chain state is not directly accessible in the EVM (though [EIP-4788 ↗](https://eips.ethereum.org/EIPS/eip-4788) aims to address this), oracles fetch essential validator data.
