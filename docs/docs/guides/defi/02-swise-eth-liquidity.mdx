...
:::custom-info[Migration Available]
If you are a liquidity provider in the SWISE-sETH2 pool and are looking to migrate liquidity to the SWISE-ETH pool, we have included the instructions for removing liquidity and swapping sETH2 for ETH [here](/docs/intro).
:::
...
:::custom-warning[Important Pool Settings]
