---
title: Prepare Operator
description: Prepare StakeWise Operator v3 by generating validator keystores, creating a hot wallet, and uploading deposit data to your Vault.
---
...
Alternatively, you may use external tools such as [Wagyu Key Gen ↗](https://github.com/stake-house/wagyu-key-gen) to generate keystores, and existing wallets like [MetaMask ↗](https://metamask.io/) or [MyEtherWallet ↗](https://help.myetherwallet.com/en/articles/6512619-using-mew-offline) for the Operator wallet.

This section walks you through the validator key generation process using the Operator Service built-in tools.

<Image img={require('../img/prepare_operator.png')} alt="prepare_operator" />
...
```
Enter the network name (mainnet, hoodi, gnosis) [mainnet]: hoodi
...
2. Upload the deposit data file to your Vault as described in [Step 5: Upload Deposit Data File →](./prepare-operator#step-5-upload-deposit-data-file-to-vault)
...
:::custom-notes[Mnemonic]
This mnemonic can be the same as the one used to generate the validator keys, or a different one.
:::
...
1. Connect your wallet and navigate to the [Operate page ↗](https://app.stakewise.io/operate)
...
`DepositDataRegistry` contracts:
  - Ethereum: [`0x75AB6DdCe07556639333d3Df1eaa684F5735223e` ↗](https://etherscan.io/address/0x75AB6DdCe07556639333d3Df1eaa684F5735223e)
  - Gnosis: [`0x58e16621B5c0786D6667D2d54E28A20940269E16` ↗](https://gnosisscan.io/address/0x58e16621B5c0786D6667D2d54E28A20940269E16)

You can interact with these contracts via Etherscan or CLI tools like [eth-cli ↗](https://github.com/protofire/eth-cli). The ABI is available [here ↗](https://github.com/stakewise/v3-core/blob/v3.0.0/abi/IDepositDataRegistry.json).
:::
